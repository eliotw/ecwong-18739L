...
bb3:                                              ; preds = %bb2, %bb1
  %19 = load i8** %str_answer_addr, align 8, !dbg !136
  %20 = call i32 (...)* @free(i8* %19) nounwind, !dbg !136
  store i32 0, i32* %0, align 4, !dbg !137
  %21 = load i32* %0, align 4, !dbg !137
  store i32 %21, i32* %retval, align 4, !dbg !137
  %retval4 = load i32* %retval, !dbg !137
  ret i32 %retval4, !dbg !137
}
...
!137 = metadata !{i32 29, i32 0, metadata !131, null}
