...
entry:
  ...
  %in1 = bitcast [10 x i8]* %in to i8*, !dbg !127
  call void @klee_make_symbolic(i8* %in1, i64 10, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !127
  %in2 = bitcast [10 x i8]* %in to i8*, !dbg !129
...
define i32 @orig_main(i8* %str_answer) nounwind {
entry:
  %str_answer_addr = alloca i8*, align 8
  %retval = alloca i32
  %0 = alloca i32
  %answer_size = alloca i64
  %answer = alloca i32*
  %"alloca point" = bitcast i32 0 to i32
  ...
  %2 = call i32 (...)* @trim(i8* %1) nounwind, !dbg !132
  %3 = load i8** %str_answer_addr, align 8, !dbg !133
  %4 = bitcast i8* %3 to i32*, !dbg !133
  store i32* %4, i32** %answer, align 8, !dbg !133
  %5 = load i32** %answer, align 8, !dbg !134
  %6 = getelementptr inbounds i32* %5, i64 0, !dbg !134
  %7 = load i32* %6, align 1, !dbg !134
  %8 = icmp ne i32 %7, 1382381155, !dbg !134
  br i1 %8, label %bb2, label %bb, !dbg !134

bb:                                               ; preds = %entry
  %9 = load i32** %answer, align 8, !dbg !134
  %10 = getelementptr inbounds i32* %9, i64 1, !dbg !134
  %11 = load i32* %10, align 1, !dbg !134
  %12 = icmp ne i32 %11, 811885857, !dbg !134
  br i1 %12, label %bb2, label %bb1, !dbg !134

bb1:                                              ; preds = %bb
  %13 = call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !135
  br label %bb3, !dbg !135

bb2:                                              ; preds = %bb, %entry
  %14 = load i32** %answer, align 8, !dbg !136
  %15 = getelementptr inbounds i32* %14, i64 1, !dbg !136
  %16 = load i32* %15, align 1, !dbg !136
  %17 = load i32** %answer, align 8, !dbg !136
  %18 = getelementptr inbounds i32* %17, i64 0, !dbg !136
  %19 = load i32* %18, align 1, !dbg !136
  %20 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([29 x i8]* @.str2, i64 0, i64 0), i32 %19, i32 %16) nounwind, !dbg !136
  br label %bb3, !dbg !136

bb3:                                              ; preds = %bb2, %bb1
  %21 = load i8** %str_answer_addr, align 8, !dbg !137
  %22 = call i32 (...)* @free(i8* %21) nounwind, !dbg !137
  store i32 0, i32* %0, align 4, !dbg !138
  %23 = load i32* %0, align 4, !dbg !138
  store i32 %23, i32* %retval, align 4, !dbg !138
...
!6 = metadata !{i32 589870, i32 0, metadata !1, metadata !"orig_main", metadata !"orig_main", metadata !"orig_main", metadata !1, i32 12, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i8*)* @orig_main} ; [ DW_TAG_subprogram 
...
!127 = metadata !{i32 7, i32 0, metadata !128, null}
...
!134 = metadata !{i32 22, i32 0, metadata !131, null}
!135 = metadata !{i32 23, i32 0, metadata !131, null}
!136 = metadata !{i32 25, i32 0, metadata !131, null}
!137 = metadata !{i32 28, i32 0, metadata !131, null}
!138 = metadata !{i32 29, i32 0, metadata !131, null}
