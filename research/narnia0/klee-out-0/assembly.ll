...
@.str1 = private unnamed_addr constant [51 x i8] c"Correct val's value from 0x41414141 -> 0xdeadbeef!\00", align 8
...
entry:
  ...
  %in1 = bitcast [24 x i8]* %in to i8*, !dbg !127
  call void @klee_make_symbolic(i8* %in1, i64 24, i8* getelementptr inbounds ([3 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !127
  %in2 = bitcast [24 x i8]* %in to i8*, !dbg !129
...
entry:
  ...
  store i64 1094795585, i64* %val, align 8, !dbg !130
  %1 = call i32 @puts(i8* getelementptr inbounds ([51 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !132
  %2 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([22 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !133
  %buf1 = bitcast [20 x i8]* %buf to i8*, !dbg !134
  %3 = load i8** %in_addr, align 8, !dbg !134
  %4 = call i8* @strncpy(i8* noalias %buf1, i8* noalias %3, i64 24) nounwind, !dbg !134
  %buf2 = bitcast [20 x i8]* %buf to i8*, !dbg !135
  %5 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i8* %buf2) nounwind, !dbg !135
  %6 = load i64* %val, align 8, !dbg !136
  %7 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([13 x i8]* @.str4, i64 0, i64 0), i64 %6) nounwind, !dbg !136
  %8 = load i64* %val, align 8, !dbg !137
  %9 = icmp eq i64 %8, 3735928559, !dbg !137
  br i1 %9, label %bb, label %bb3, !dbg !137

bb:                                               ; preds = %entry
  %10 = call i32 @system(i8* getelementptr inbounds ([8 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !138
...
bb3:                                              ; preds = %entry
  %12 = call i32 @puts(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !141
...
!162 = metadata !{i32 15, i32 0, metadata !113, null}
!163 = metadata !{i32 16, i32 0, metadata !113, null}
!164 = metadata !{i32 17, i32 0, metadata !113, null}
