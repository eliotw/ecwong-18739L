...
@.str9 = private unnamed_addr constant [15 x i8] c"binary_demo1.c\00", align 1
@__PRETTY_FUNCTION__.2665 = internal unnamed_addr constant [10 x i8] c"orig_main\00"
@.str10 = private unnamed_addr constant [6 x i8] c"sh -i\00", align 1
@.str11 = private unnamed_addr constant [6 x i8] c"nope!\00", align 1
@.str12 = private constant [22 x i8] c"klee_div_zero_check.c\00", align 1
@.str113 = private constant [15 x i8] c"divide by zero\00", align 1
@.str214 = private constant [8 x i8] c"div.err\00", align 1
@.str315 = private constant [8 x i8] c"IGNORED\00", align 1
@.str14 = private constant [16 x i8] c"overshift error\00", align 1
@.str25 = private constant [14 x i8] c"overshift.err\00", align 1
@.str616 = private constant [13 x i8] c"klee_range.c\00", align 1
...
entry:
  ...
  %in1 = bitcast [24 x i8]* %in to i8*, !dbg !130
  call void @klee_make_symbolic(i8* %in1, i64 24, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !130
  ...
  %in3 = bitcast [24 x i8]* %in to i8*, !dbg !132
...
bb15:                                             ; preds = %bb14
  ...
  %83 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str8, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8]* @.str9, i64 0, i64 0), i32 55, i8* getelementptr inbounds ([10 x i8]* @__PRETTY_FUNCTION__.2665, i64 0, i64 0)) nou
  unreachable

bb16:                                             ; preds = %bb14, %bb7, %bb6, %bb5, %bb4, %bb3, %bb2, %bb1
  %84 = call i32 @puts(i8* getelementptr inbounds ([6 x i8]* @.str11, i64 0, i64 0)) nounwind, !dbg !150
  store i32 0, i32* %0, align 4, !dbg !151
  br label %bb17, !dbg !151

bb17:                                             ; preds = %bb16, %bb13, %bb9, %bb
  %85 = load i32* %0, align 4, !dbg !138
  store i32 %85, i32* %retval, align 4, !dbg !138
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str12, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str113, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str214, i64 0, i64 0)) noreturn nounwind, !
  unreachable, !dbg !154
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str315, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) noreturn nounwind, !db
  unreachable, !dbg !160
...
bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str616, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !1
  unreachable, !dbg !163
...
!149 = metadata !{i32 55, i32 0, metadata !135, null}
!150 = metadata !{i32 62, i32 0, metadata !135, null}
!151 = metadata !{i32 63, i32 0, metadata !135, null}
