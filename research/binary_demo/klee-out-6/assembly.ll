...
entry:
  ...
  %in1 = bitcast [22 x i8]* %in to i8*, !dbg !130
  call void @klee_make_symbolic(i8* %in1, i64 22, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !130
  ...
  %in3 = bitcast [22 x i8]* %in to i8*, !dbg !132
