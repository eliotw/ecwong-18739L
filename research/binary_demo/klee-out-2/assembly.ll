...
@.str10 = private unnamed_addr constant [6 x i8] c"nope!\00", align 1
@.str11 = private constant [22 x i8] c"klee_div_zero_check.c\00", align 1
@.str112 = private constant [15 x i8] c"divide by zero\00", align 1
@.str213 = private constant [8 x i8] c"div.err\00", align 1
@.str314 = private constant [8 x i8] c"IGNORED\00", align 1
@.str14 = private constant [16 x i8] c"overshift error\00", align 1
@.str25 = private constant [14 x i8] c"overshift.err\00", align 1
@.str615 = private constant [13 x i8] c"klee_range.c\00", align 1
...
entry:
  ...
  %in1 = bitcast [21 x i8]* %in to i8*, !dbg !130
  call void @klee_make_symbolic(i8* %in1, i64 21, i8* getelementptr inbounds ([3 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !130
  ...
  %in3 = bitcast [21 x i8]* %in to i8*, !dbg !132
...
bb16:                                             ; preds = %bb14, %bb7, %bb6, %bb5, %bb4, %bb3, %bb2, %bb1
  %84 = call i32 @puts(i8* getelementptr inbounds ([6 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !150
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str11, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str112, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str213, i64 0, i64 0)) noreturn nounwind, !
  unreachable, !dbg !154
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str314, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) noreturn nounwind, !db
  unreachable, !dbg !160
...
bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str615, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !1
  unreachable, !dbg !163
