...
@.str6 = private unnamed_addr constant [39 x i8] c"source code is available in level02.c\0A\00", align 8
...
entry:
  ...
  %argv = alloca [3 x i8*]
  %"alloca point" = bitcast i32 0 to i32
  %in11 = bitcast [32 x i8]* %in1 to i8*, !dbg !135
  call void @klee_make_symbolic(i8* %in11, i64 32, i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !135
  %in22 = bitcast [32 x i8]* %in2 to i8*, !dbg !137
  call void @klee_make_symbolic(i8* %in22, i64 32, i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !137
  %1 = getelementptr inbounds [3 x i8*]* %argv, i64 0, i64 0, !dbg !138
  %in13 = bitcast [32 x i8]* %in1 to i8*, !dbg !138
  store i8* %in13, i8** %1, align 8, !dbg !138
  %2 = getelementptr inbounds [3 x i8*]* %argv, i64 0, i64 1, !dbg !139
  %in14 = bitcast [32 x i8]* %in1 to i8*, !dbg !139
  store i8* %in14, i8** %2, align 8, !dbg !139
  %3 = getelementptr inbounds [3 x i8*]* %argv, i64 0, i64 2, !dbg !140
  %in25 = bitcast [32 x i8]* %in2 to i8*, !dbg !140
  store i8* %in25, i8** %3, align 8, !dbg !140
  %argv6 = bitcast [3 x i8*]* %argv to i8**, !dbg !141
  %4 = call i32 (...)* bitcast (i32 (i32, i8**)* @orig_main to i32 (...)*)(i32 3, i8** %argv6) nounwind, !dbg !141
  store i32 %4, i32* %0, align 4, !dbg !141
  %5 = load i32* %0, align 4, !dbg !141
  store i32 %5, i32* %retval, align 4, !dbg !141
  %retval7 = load i32* %retval, !dbg !141
  ret i32 %retval7, !dbg !141
}
...
entry:
  ...
  %1 = call i32 @puts(i8* getelementptr inbounds ([39 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !142
  %2 = load i32* %argc_addr, align 4, !dbg !144
  %3 = icmp ne i32 %2, 3, !dbg !144
  br i1 %3, label %bb1, label %bb, !dbg !144

bb:                                               ; preds = %entry
  %4 = load i8*** %argv_addr, align 8, !dbg !144
  %5 = getelementptr inbounds i8** %4, i64 2, !dbg !144
  %6 = load i8** %5, align 1, !dbg !144
  %7 = call i32 @atoi(i8* %6) nounwind readonly, !dbg !144
  %8 = icmp eq i32 %7, 0, !dbg !144
  br i1 %8, label %bb1, label %bb2, !dbg !144
...
bb2:                                              ; preds = %bb
  %9 = call void (i32)* (i32, void (i32)*)* @signal(i32 8, void (i32)* @catcher) nounwind, !dbg !146
  %10 = load i8*** %argv_addr, align 8, !dbg !147
  %11 = getelementptr inbounds i8** %10, i64 1, !dbg !147
  %12 = load i8** %11, align 1, !dbg !147
  %13 = call i32 @atoi(i8* %12) nounwind readonly, !dbg !147
  %neg = sub i32 0, %13, !dbg !147
  %abscond = icmp sge i32 %13, 0, !dbg !147
  %abs = select i1 %abscond, i32 %13, i32 %neg, !dbg !147
  %14 = load i8*** %argv_addr, align 8, !dbg !147
  %15 = getelementptr inbounds i8** %14, i64 2, !dbg !147
  %16 = load i8** %15, align 1, !dbg !147
  %17 = call i32 @atoi(i8* %16) nounwind readonly, !dbg !147
  %int_cast_to_i64 = zext i32 %17 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !147
  %18 = sdiv i32 %abs, %17, !dbg !147
  store i32 %18, i32* %0, align 4, !dbg !147
  br label %bb4, !dbg !147

bb4:                                              ; preds = %bb2, %bb1
  %19 = load i32* %0, align 4, !dbg !145
  store i32 %19, i32* %retval, align 4, !dbg !145
  %retval5 = load i32* %retval, !dbg !145
  ret i32 %retval5, !dbg !145
}
...
entry:
  ...
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !152
...
bb3:                                              ; preds = %bb1
  ...
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !161
...
!9 = metadata !{i32 589870, i32 0, metadata !1, metadata !"orig_main", metadata !"orig_main", metadata !"orig_main", metadata !1, i32 37, metadata !10, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i8**)* @orig_main} ; [ DW_TAG_subp
...
!135 = metadata !{i32 26, i32 0, metadata !136, null}
!136 = metadata !{i32 589835, metadata !6, i32 20, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 27, i32 0, metadata !136, null}
!138 = metadata !{i32 29, i32 0, metadata !136, null}
!139 = metadata !{i32 30, i32 0, metadata !136, null}
!140 = metadata !{i32 31, i32 0, metadata !136, null}
!141 = metadata !{i32 33, i32 0, metadata !136, null}
!142 = metadata !{i32 38, i32 0, metadata !143, null}
!143 = metadata !{i32 589835, metadata !9, i32 37, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!144 = metadata !{i32 40, i32 0, metadata !143, null}
!145 = metadata !{i32 41, i32 0, metadata !143, null}
!146 = metadata !{i32 42, i32 0, metadata !143, null}
!147 = metadata !{i32 43, i32 0, metadata !143, null}
!148 = metadata !{i32 13, i32 0, metadata !149, null}
!149 = metadata !{i32 589835, metadata !15, i32 12, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ]
!150 = metadata !{i32 14, i32 0, metadata !149, null}
!151 = metadata !{i32 15, i32 0, metadata !149, null}
!152 = metadata !{i32 15, i32 0, metadata !85, null}
!153 = metadata !{i32 16, i32 0, metadata !85, null}
!154 = metadata !{i32 21, i32 0, metadata !155, null}
!155 = metadata !{i32 589835, metadata !30, i32 20, i32 0, metadata !31, i32 0} ; [ DW_TAG_lexical_block ]
!156 = metadata !{i32 27, i32 0, metadata !155, null}
!157 = metadata !{i32 29, i32 0, metadata !155, null}
!158 = metadata !{i32 16, i32 0, metadata !92, null}
!159 = metadata !{i32 17, i32 0, metadata !92, null}
!160 = metadata !{i32 19, i32 0, metadata !92, null}
!161 = metadata !{i32 22, i32 0, metadata !92, null}
!162 = metadata !{i32 25, i32 0, metadata !92, null}
!163 = metadata !{i32 26, i32 0, metadata !92, null}
!164 = metadata !{i32 28, i32 0, metadata !92, null}
!165 = metadata !{i32 29, i32 0, metadata !92, null}
!166 = metadata !{i32 32, i32 0, metadata !92, null}
!167 = metadata !{i32 20, i32 0, metadata !92, null}
!168 = metadata !{i32 15, i32 0, metadata !117, null}
!169 = metadata !{i32 16, i32 0, metadata !117, null}
!170 = metadata !{i32 17, i32 0, metadata !117, null}
