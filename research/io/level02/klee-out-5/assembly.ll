...
@.str6 = private unnamed_addr constant [5 x i8] c"test\00", align 1
@.str7 = private unnamed_addr constant [39 x i8] c"source code is available in level02.c\0A\00", align 8
@.str8 = private unnamed_addr constant [12 x i8] c"Got to here\00", align 1
...
entry:
  ...
  %in14 = bitcast [4 x i8]* %in1 to i8*, !dbg !139
  store i8* %in14, i8** %2, align 8, !dbg !139
  %3 = getelementptr inbounds [3 x i8*]* %argv, i64 0, i64 2, !dbg !140
  %in25 = bitcast [4 x i8]* %in2 to i8*, !dbg !140
  store i8* %in25, i8** %3, align 8, !dbg !140
  %4 = call i32 (i8*, ...)* @printf(i8* noalias getelementptr inbounds ([5 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !141
  %argv6 = bitcast [3 x i8*]* %argv to i8**, !dbg !142
  %5 = call i32 (...)* bitcast (i32 (i32, i8**)* @orig_main to i32 (...)*)(i32 3, i8** %argv6) nounwind, !dbg !142
  store i32 %5, i32* %0, align 4, !dbg !142
  %6 = load i32* %0, align 4, !dbg !142
  store i32 %6, i32* %retval, align 4, !dbg !142
  %retval7 = load i32* %retval, !dbg !142
  ret i32 %retval7, !dbg !142
}
...
entry:
  ...
  %1 = call i32 @puts(i8* getelementptr inbounds ([39 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !143
  %2 = load i32* %argc_addr, align 4, !dbg !145
  %3 = icmp ne i32 %2, 3, !dbg !145
  br i1 %3, label %bb1, label %bb, !dbg !145

bb:                                               ; preds = %entry
  %4 = load i8*** %argv_addr, align 8, !dbg !145
  %5 = getelementptr inbounds i8** %4, i64 2, !dbg !145
  %6 = load i8** %5, align 1, !dbg !145
  %7 = call i32 @atoi(i8* %6) nounwind readonly, !dbg !145
  %8 = icmp eq i32 %7, 0, !dbg !145
  br i1 %8, label %bb1, label %bb2, !dbg !145
...
bb2:                                              ; preds = %bb
  %9 = call i32 @puts(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !147
  %10 = call void (i32)* (i32, void (i32)*)* @signal(i32 8, void (i32)* @catcher) nounwind, !dbg !148
  %11 = load i8*** %argv_addr, align 8, !dbg !149
  %12 = getelementptr inbounds i8** %11, i64 1, !dbg !149
  %13 = load i8** %12, align 1, !dbg !149
  %14 = call i32 @atoi(i8* %13) nounwind readonly, !dbg !149
  %neg = sub i32 0, %14, !dbg !149
  %abscond = icmp sge i32 %14, 0, !dbg !149
  %abs = select i1 %abscond, i32 %14, i32 %neg, !dbg !149
  %15 = load i8*** %argv_addr, align 8, !dbg !149
  %16 = getelementptr inbounds i8** %15, i64 2, !dbg !149
  %17 = load i8** %16, align 1, !dbg !149
  %18 = call i32 @atoi(i8* %17) nounwind readonly, !dbg !149
  %int_cast_to_i64 = zext i32 %18 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !149
  %19 = sdiv i32 %abs, %18, !dbg !149
  store i32 %19, i32* %0, align 4, !dbg !149
  br label %bb4, !dbg !149

bb4:                                              ; preds = %bb2, %bb1
  %20 = load i32* %0, align 4, !dbg !146
  store i32 %20, i32* %retval, align 4, !dbg !146
  %retval5 = load i32* %retval, !dbg !146
  ret i32 %retval5, !dbg !146
}
...
!138 = metadata !{i32 37, i32 0, metadata !136, null}
!139 = metadata !{i32 38, i32 0, metadata !136, null}
!140 = metadata !{i32 39, i32 0, metadata !136, null}
!141 = metadata !{i32 40, i32 0, metadata !136, null}
!142 = metadata !{i32 42, i32 0, metadata !136, null}
!143 = metadata !{i32 47, i32 0, metadata !144, null}
!144 = metadata !{i32 589835, metadata !9, i32 46, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!145 = metadata !{i32 49, i32 0, metadata !144, null}
!146 = metadata !{i32 50, i32 0, metadata !144, null}
!147 = metadata !{i32 51, i32 0, metadata !144, null}
!148 = metadata !{i32 52, i32 0, metadata !144, null}
!149 = metadata !{i32 53, i32 0, metadata !144, null}
