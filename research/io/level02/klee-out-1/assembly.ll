...
@__PRETTY_FUNCTION__.2877 = internal unnamed_addr constant [8 x i8] c"catcher\00"
...
@.str7 = private unnamed_addr constant [39 x i8] c"source code is available in level02.c\0A\00", align 8
@.str8 = private constant [22 x i8] c"klee_div_zero_check.c\00", align 1
@.str19 = private constant [15 x i8] c"divide by zero\00", align 1
@.str210 = private constant [8 x i8] c"div.err\00", align 1
@.str311 = private constant [8 x i8] c"IGNORED\00", align 1
@.str14 = private constant [16 x i8] c"overshift error\00", align 1
@.str25 = private constant [14 x i8] c"overshift.err\00", align 1
@.str612 = private constant [13 x i8] c"klee_range.c\00", align 1
...
entry:
  ...
  %5 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8]* @.str2, i64 0, i64 0), i32 13, i8* getelementptr inbounds ([8 x i8]* @__PRETTY_FUNCTION__.2877, i64 0, i64 0)) nounw
  unreachable
}
...
entry:
  ...
  %argv8 = bitcast [3 x i8*]* %argv to i8**, !dbg !143
  %8 = call i32 (...)* bitcast (i32 (i32, i8**)* @orig_main to i32 (...)*)(i32 3, i8** %argv8) nounwind, !dbg !143
  store i32 %8, i32* %0, align 4, !dbg !143
  %9 = load i32* %0, align 4, !dbg !143
  store i32 %9, i32* %retval, align 4, !dbg !143
  %retval9 = load i32* %retval, !dbg !143
  ret i32 %retval9, !dbg !143
}
...
entry:
  ...
  %1 = call i32 @puts(i8* getelementptr inbounds ([39 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !144
  %2 = load i32* %argc_addr, align 4, !dbg !146
  %3 = icmp ne i32 %2, 3, !dbg !146
  br i1 %3, label %bb1, label %bb, !dbg !146

bb:                                               ; preds = %entry
  %4 = load i8*** %argv_addr, align 8, !dbg !146
  %5 = getelementptr inbounds i8** %4, i64 2, !dbg !146
  %6 = load i8** %5, align 1, !dbg !146
  %7 = call i32 @atoi(i8* %6) nounwind readonly, !dbg !146
  %8 = icmp eq i32 %7, 0, !dbg !146
  br i1 %8, label %bb1, label %bb2, !dbg !146
...
bb2:                                              ; preds = %bb
  %9 = call void (i32)* (i32, void (i32)*)* @signal(i32 8, void (i32)* @catcher) nounwind, !dbg !148
  %10 = load i8*** %argv_addr, align 8, !dbg !149
  %11 = getelementptr inbounds i8** %10, i64 1, !dbg !149
  %12 = load i8** %11, align 1, !dbg !149
  %13 = call i32 @atoi(i8* %12) nounwind readonly, !dbg !149
  %neg = sub i32 0, %13, !dbg !149
  %abscond = icmp sge i32 %13, 0, !dbg !149
  %abs = select i1 %abscond, i32 %13, i32 %neg, !dbg !149
  %14 = load i8*** %argv_addr, align 8, !dbg !149
  %15 = getelementptr inbounds i8** %14, i64 2, !dbg !149
  %16 = load i8** %15, align 1, !dbg !149
  %17 = call i32 @atoi(i8* %16) nounwind readonly, !dbg !149
  %int_cast_to_i64 = zext i32 %17 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !149
  %18 = sdiv i32 %abs, %17, !dbg !149
  store i32 %18, i32* %0, align 4, !dbg !149
  br label %bb4, !dbg !149

bb4:                                              ; preds = %bb2, %bb1
  %19 = load i32* %0, align 4, !dbg !147
  store i32 %19, i32* %retval, align 4, !dbg !147
  %retval5 = load i32* %retval, !dbg !147
  ret i32 %retval5, !dbg !147
}
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str8, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str19, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str210, i64 0, i64 0)) noreturn nounwind, !db
  unreachable, !dbg !152
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str311, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) noreturn nounwind, !db
  unreachable, !dbg !158
...
bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str612, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !1
  unreachable, !dbg !161
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"catcher", metadata !"catcher", metadata !"catcher", metadata !1, i32 10, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (i32)* @catcher} ; [ DW_TAG_subprogram ]
...
!9 = metadata !{i32 589870, i32 0, metadata !1, metadata !"orig_main", metadata !"orig_main", metadata !"orig_main", metadata !1, i32 44, metadata !10, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i8**)* @orig_main} ; [ DW_TAG_subp
...
!132 = metadata !{i32 589835, metadata !0, i32 10, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 12, i32 0, metadata !132, null}
!134 = metadata !{i32 13, i32 0, metadata !132, null}
!135 = metadata !{i32 30, i32 0, metadata !136, null}
!136 = metadata !{i32 589835, metadata !6, i32 20, i32 0, metadata !1, i32 1} ; [ DW_TAG_lexical_block ]
!137 = metadata !{i32 31, i32 0, metadata !136, null}
!138 = metadata !{i32 33, i32 0, metadata !136, null}
!139 = metadata !{i32 34, i32 0, metadata !136, null}
!140 = metadata !{i32 36, i32 0, metadata !136, null}
!141 = metadata !{i32 37, i32 0, metadata !136, null}
!142 = metadata !{i32 38, i32 0, metadata !136, null}
!143 = metadata !{i32 40, i32 0, metadata !136, null}
!144 = metadata !{i32 45, i32 0, metadata !145, null}
!145 = metadata !{i32 589835, metadata !9, i32 44, i32 0, metadata !1, i32 2} ; [ DW_TAG_lexical_block ]
!146 = metadata !{i32 47, i32 0, metadata !145, null}
!147 = metadata !{i32 48, i32 0, metadata !145, null}
!148 = metadata !{i32 49, i32 0, metadata !145, null}
!149 = metadata !{i32 50, i32 0, metadata !145, null}
!150 = metadata !{i32 13, i32 0, metadata !151, null}
!151 = metadata !{i32 589835, metadata !15, i32 12, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ]
!152 = metadata !{i32 14, i32 0, metadata !151, null}
!153 = metadata !{i32 15, i32 0, metadata !151, null}
!154 = metadata !{i32 15, i32 0, metadata !85, null}
!155 = metadata !{i32 16, i32 0, metadata !85, null}
!156 = metadata !{i32 21, i32 0, metadata !157, null}
!157 = metadata !{i32 589835, metadata !30, i32 20, i32 0, metadata !31, i32 0} ; [ DW_TAG_lexical_block ]
!158 = metadata !{i32 27, i32 0, metadata !157, null}
!159 = metadata !{i32 29, i32 0, metadata !157, null}
!160 = metadata !{i32 16, i32 0, metadata !92, null}
!161 = metadata !{i32 17, i32 0, metadata !92, null}
!162 = metadata !{i32 19, i32 0, metadata !92, null}
!163 = metadata !{i32 22, i32 0, metadata !92, null}
!164 = metadata !{i32 25, i32 0, metadata !92, null}
!165 = metadata !{i32 26, i32 0, metadata !92, null}
!166 = metadata !{i32 28, i32 0, metadata !92, null}
!167 = metadata !{i32 29, i32 0, metadata !92, null}
!168 = metadata !{i32 32, i32 0, metadata !92, null}
!169 = metadata !{i32 20, i32 0, metadata !92, null}
!170 = metadata !{i32 15, i32 0, metadata !117, null}
!171 = metadata !{i32 16, i32 0, metadata !117, null}
!172 = metadata !{i32 17, i32 0, metadata !117, null}
