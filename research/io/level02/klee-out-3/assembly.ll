...
bb2:                                              ; preds = %bb
  %9 = call i32 @puts(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !148
  %10 = call void (i32)* (i32, void (i32)*)* @signal(i32 8, void (i32)* @catcher) nounwind, !dbg !149
  %11 = load i8*** %argv_addr, align 8, !dbg !150
  %12 = getelementptr inbounds i8** %11, i64 1, !dbg !150
  %13 = load i8** %12, align 1, !dbg !150
  %14 = call i32 @atoi(i8* %13) nounwind readonly, !dbg !150
  %neg = sub i32 0, %14, !dbg !150
  %abscond = icmp sge i32 %14, 0, !dbg !150
  %abs = select i1 %abscond, i32 %14, i32 %neg, !dbg !150
  %15 = load i8*** %argv_addr, align 8, !dbg !150
  %16 = getelementptr inbounds i8** %15, i64 2, !dbg !150
  %17 = load i8** %16, align 1, !dbg !150
  %18 = call i32 @atoi(i8* %17) nounwind readonly, !dbg !150
  %int_cast_to_i64 = zext i32 %18 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !150
  %19 = sdiv i32 %abs, %18, !dbg !150
  store i32 %19, i32* %0, align 4, !dbg !150
  br label %bb4, !dbg !150

bb4:                                              ; preds = %bb2, %bb1
  %20 = load i32* %0, align 4, !dbg !147
  store i32 %20, i32* %retval, align 4, !dbg !147
...
!150 = metadata !{i32 52, i32 0, metadata !145, null}
!151 = metadata !{i32 13, i32 0, metadata !152, null}
!152 = metadata !{i32 589835, metadata !15, i32 12, i32 0, metadata !16, i32 0} ; [ DW_TAG_lexical_block ]
!153 = metadata !{i32 14, i32 0, metadata !152, null}
!154 = metadata !{i32 15, i32 0, metadata !152, null}
!155 = metadata !{i32 15, i32 0, metadata !85, null}
!156 = metadata !{i32 16, i32 0, metadata !85, null}
!157 = metadata !{i32 21, i32 0, metadata !158, null}
!158 = metadata !{i32 589835, metadata !30, i32 20, i32 0, metadata !31, i32 0} ; [ DW_TAG_lexical_block ]
!159 = metadata !{i32 27, i32 0, metadata !158, null}
!160 = metadata !{i32 29, i32 0, metadata !158, null}
!161 = metadata !{i32 16, i32 0, metadata !92, null}
!162 = metadata !{i32 17, i32 0, metadata !92, null}
!163 = metadata !{i32 19, i32 0, metadata !92, null}
!164 = metadata !{i32 22, i32 0, metadata !92, null}
!165 = metadata !{i32 25, i32 0, metadata !92, null}
!166 = metadata !{i32 26, i32 0, metadata !92, null}
!167 = metadata !{i32 28, i32 0, metadata !92, null}
!168 = metadata !{i32 29, i32 0, metadata !92, null}
!169 = metadata !{i32 32, i32 0, metadata !92, null}
!170 = metadata !{i32 20, i32 0, metadata !92, null}
!171 = metadata !{i32 15, i32 0, metadata !117, null}
!172 = metadata !{i32 16, i32 0, metadata !117, null}
!173 = metadata !{i32 17, i32 0, metadata !117, null}
